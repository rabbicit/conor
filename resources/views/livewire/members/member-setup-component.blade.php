                    ...
                    <div class="user-details">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!--    @endforeach-->
                                <!--</select>-->
                                <input type="text" name="state" class="states order-alpha" id="stateId" wire:model="state" placeholder="Type Your State">
                                <div class="error-code">
                            ...
                            <div class="col-md-6">
                                ...
                                <!--    @endforeach-->
                                <!--</select>-->
                                <input type="text" name="city" class="cities order-alpha" id="cityId" wire:model="city" placeholder="Type Your City">
                                <div class="error-code">
                    ...
                    <div class="pricing-packages">
                        ...
                        <div class="another-row">
                            <div class="single-pricing">
                                <input id="p{{ $plan->id }}" type="radio" name="package" wire:model="package" value="{{ route('plans.show', $plan->slug) }}">
                                <label for="p{{ $plan->id }}"></label>
